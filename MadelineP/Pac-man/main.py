...
player_images = []
for i in range (1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/player_images/{i}.png'), (45, 45)))

blinky_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/red.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/pink.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/blue.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/orange.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/powerup.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'MadelineP/Pac-man/assets/ghost_images/dead.png'), (45, 45))
...
class Ghost:
    ...
    def draw(self):
        if (not powerup and not self.dead) or (eaten_ghost[self.id] and powerup and not self.dead):
            screen.blit(self.img, (self.x_pos, self.ypos))
        elif powerup and not self.dead and not eaten_ghost[self.id]:
            screen.blit(spooked_img, (self.x_pos, self.ypos))
        else:
            screen.blit(dead_img, (self.x_pos, self.ypos))
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 30 < 29:
            ...
            if self.direct == 0 or self.direct == 1:
                if 12 <= self.center_x % num2 <= 18:
                    if level[(self.center_y + num3)// num1][self.center_x//num2] < 3 \
                     ...
                     #check typo for self.center_y
                    if level[(self.center_y - num3)// num1][self.center_x//num2] < 3 \
                        or (level[(center_y - num3)// num1][self.center_x//num2]  == 9 and (self.in_box or self.dead)): #this line
                            self.turns[2] = True
                
                 #check typo for self.center_y
                if 12 <= self.center_y % num1 <= 18:
                    #this line ↓
                    if level[center_y // num1][(self.center_x - num3)//num2] < 3 \
                        or (level[center_y // num1][(self.center_x - num3)//num2]  == 9 and (self.in_box or self.dead)): #this line
                            self.turns[1] = True
            ...
            self.turns[0] = True
            self.turns[1] = True
        if 350 < self.x_pos < 550 and 370 < self.ypos < 480:
            self.in_box = True
        else:
            self.in_box = False
...
#revisit clyde code possible typos but does not cause any errors
    def move_clyde(self):
        if self.direct == 0:
...
def get_targets(blink_x, blink_y, ink_x, ink_y, pink_x, pink_y, clyd_x, clyd_y):
    ...
    if powerup:
        ...
        if not inky_dead:
            if 340 < inky_x < 560 and 340 <ink_y < 500:
                ink_target = (400, 100)
            else:
