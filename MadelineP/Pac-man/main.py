...
def draw_player():
    if direction == 0:
        ...
        screen.blit(pygame.transorm.flip(player_images[counter // 5], True, False), (player_x, player_y))  
    
    elif direction == 2:
        screen.blit(pygame.transorm.rotate(player_images[counter // 5], 90), (player_x, player_y))  
    
    elif direction == 3:
        screen.blit(pygame.transorm.rotate(player_images[counter // 5], 270), (player_x, player_y))  
