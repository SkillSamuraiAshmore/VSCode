import turtle
from illusion_helper import drawSquare, drawDiamond
...
pattern = [primroseColour1, primroseColour2, primroseColour1, primroseColour2, primroseColour1, primroseColour2, primroseColour1, primroseColour2,]       
        
for y in range (-6, 8, 1):
    for x in range(-6, 8, 1):
        drawSquare(turtle, gridSize*x, gridSize*y, primroseSize, pattern[(x+y-1)%8])
