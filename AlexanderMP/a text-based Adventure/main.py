...
def fight_dragon():
    typewriter("are you brave enough to fight a dragon or are you gonna chicken out will you [fight or run]")
    decision = input()

    if decision == "fight":
        typewriter("hey dont blame me that your to weak as he blows a unexpected smash ")
        damage (999, hp)
        typewriter("i guess you found ou theres no afterlife of that sorry maybe you might have new life....")
    elif decision == "run":
        typewriter("chickening out saved you for once as you see a  i feel lucky for you now")
    else:
        error_handler()
        fight_dragon
...
def cavern():        
    ...
    decision = input() 
    if decision == "smash":
            typewriter(" be a bit wiser next time because rocks fall over you bonking your head ouch that must hurt might as well watch out for the big one...")
...
def way():
    ...
    if decision == "left":
        ...
        typewriter(" you went the wrong way i think you should get outta there as you see a thorn through your leg you look ahead and see so many more... maybe you should go left")
